...
public class P12LittleJohn {
    public static void main(String[] args) throws IOException {
        ...
        String numberAsString = Integer.toString(small) + Integer.toString(medium) + Integer.toString(large);
        String binary = Integer.toBinaryString(Integer.valueOf(numberAsString));
